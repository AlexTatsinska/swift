...
public class GamerForm extends javax.swing.JPanel {
    ...
    public void showGamerInfo(Gamer gamer) throws SQLException, DALException, IOException {
        ...
        jLabelLeak15Gamer1.setVisible(false);
        jLabelLeak16Gamer1.setVisible(false);
        int gamerId = gamer.getGamerId();
        int leakCount = 1;
        jLabelNameGamer1.setText(gamer.getGamerName());
        try {
            gamer.setGamerLeaks(mySqlLeak.getLeaks(gamerId));  
            //System.out.println(gamer.getGamerId());
            ...
            for (Picture image : mySqlPicture.getPictures(gamerId)) {
                        
                switch (counterPicture) {                   
                    case 1:
                        jButtonPic1Gamer1.setEnabled(true);
                        jButtonPic1Gamer1.setText(image.getPictureName());
                        
                        break;
                        case 2:
                        jButtonPic2Gamer1.setEnabled(true);
                        jButtonPic2Gamer1.setText(image.getPictureName());
                        break;
                        case 3:
                        jButtonPic3Gamer1.setEnabled(true);
                        jButtonPic3Gamer1.setText(image.getPictureName());
                        break;
                        case 4:
                        jButtonPic4Gamer1.setEnabled(true);
                        jButtonPic4Gamer1.setText(image.getPictureName());
                        break;
                        case 5:
                        jButtonPic5Gamer1.setEnabled(true);
                        jButtonPic5Gamer1.setText(image.getPictureName());
                        break;
                        case 6:
                        jButtonPic6Gamer1.setEnabled(true);
                        jButtonPic6Gamer1.setText(image.getPictureName());
                        break;
                        case 7:
                        jButtonPic7Gamer1.setEnabled(true);
                        jButtonPic7Gamer1.setText(image.getPictureName());
                        break;
                        case 8:
                        jButtonPic8Gamer1.setEnabled(true);
                        jButtonPic8Gamer1.setText(image.getPictureName());
                        break;
                        case 9:
                        jButtonPic9Gamer1.setEnabled(true);
                        jButtonPic9Gamer1.setText(image.getPictureName());
                        break;
                        case 10:
                        jButtonPic10Gamer1.setEnabled(true);
                        jButtonPic10Gamer1.setText(image.getPictureName());
                        break;
                        case 11:
                        jButtonPic11Gamer1.setEnabled(true);
                        jButtonPic11Gamer1.setText(image.getPictureName());
                        break;
                        case 12:
                        jButtonPic12Gamer1.setEnabled(true);
                        jButtonPic12Gamer1.setText(image.getPictureName());
                        break;
                }
                counterPicture++;
            }
        //for (Leak leak : gamer.getGamerLeaks()) {
        for (Leak leak : mySqlLeak.getLeaks(gamerId)) {
    ...
    private void initComponents() {
        ...
        jTextAreaNotesGamer1.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        ...
        jPanelNoteGamer1Layout.setHorizontalGroup(
            ...
            .addComponent(jScrollPaneGamer1, javax.swing.GroupLayout.DEFAULT_SIZE, 231, Short.MAX_VALUE)
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanelGamer1, javax.swing.GroupLayout.PREFERRED_SIZE, 452, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void jButtonPic3Gamer1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPic3Gamer1ActionPerformed
        ...
        int count = 1;    
        try {
            for (Picture image : mySqlPicture.getPictures(gamer.getGamerId())) {
                if(count == 3){
                    JFrame picture = new JFrame();
                    picture.setName(gamer.getGamerName()+" "+image.getPictureName());
                    picture.setSize(400, 500);
                    ImageIcon icon = null;
                    icon = new ImageIcon(image.getPictureLink());
