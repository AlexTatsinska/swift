 ...
 * @author AlexT
 */
public class Task2_FileStructure_v2 {
    ...
    public static void main(String[] args) {
        ...
        FolderObject_v2 root = new FolderObject_v2(null, "/");
        ...
        while (!input.equals("END")) {
            ...
            if (command.equals("mkdir")) {
                ...
                if (lastSeparatorIndex == -1) {
                    root.addChild(new FolderObject_v2(root, path));
                } else {
                    FolderObject_v2 folder = findFolder(path.substring(0));
                    folder.addChild(new FolderObject_v2(folder, path.substring(lastSeparatorIndex + 1)));
                }
            }
    ...
    private static FolderObject_v2 findFolder(String substring) {
